...
const Navbar = ({ session, navBgColor, projectID }: NavBarProps) => {
  ...
  React.useEffect(() => {
    ...
    // console.log(session.user.name); = name as per loggin 
  }, [session]);
  ...
  const projectsOptionRef = useClickOutSide(() => setShowProjectsOption(false));
  return (
    <div
    ...
    >
      <div className={styles.nav__items_left}>
        ...
        <div className={styles.icon__container}>
          <Link href="/">
            <a className={styles.nav__icons}>
              <img src="/svg/home.svg" alt="Home icon" height={15} width={15} />
            </a>
          </Link>
        </div>
        <div className={styles.icon__container} ref={projectsOptionRef}>
          <div
            ...
            onClick={() => setShowProjectsOption(!showProjectsOption)}
          >
      ...
      <div className={styles.logo__container}>
        ...
        <Link href="/">
          <a className={styles.logo}>Tasky</a>
        </Link>
      </div>
      <div className={styles.nav__items_right}>
        {session ? (
          <div className={styles.items__container}>
            <div className={styles.icon__container} ref={createItemsRef}>
              <div
                className={styles.nav__icons}
                onClick={() => setShowCreateItems(!showCreateItems)}
              >
                <img
                  src="/svg/add.svg"
              ...
              {showCreateItems && (
                <CreateItemsDropDown closeDropdown={setShowCreateItems} />
              )}
            </div>
            <div className={styles.icon__container} ref={showTipsRef}>
              <div
                className={styles.nav__icons}
              ...
              {showTips && <TipsDropDown closeDropdown={setShowTips} />}
            </div>
            <div className={styles.icon__container}>
              <div className={styles.nav__icons}>
                <img
            ...
            <div className={styles.icon__container} ref={showAccountOptionsRef}>
              <div
